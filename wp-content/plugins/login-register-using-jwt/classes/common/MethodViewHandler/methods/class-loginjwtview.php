	...
	public function load_config_view() {
		...
		" id="<?php echo esc_attr( $this->method_slug . '_div' ); ?>" >
				...
				<tr>
					...
					<td>
						<h4 class="mo_jwt_attr_h4">
							<input type="text" name="mo_jwt_token_name_temporary" id=mo_jwt_token_name_temporary style="display:none" value="mo-jwt-token" />
			...
			>
				...
				<input type="textbox" placeholder="OAuth Introspection endpoint" name="introspection_endpoint" style="width:80%;padding:3px" class="OAuth_required" value="<?php // phpcs:ignore --Squiz.PHP.EmbeddedPhp.ContentBeforeOpen since it's inside an input text area indenting will add spaces to the input.
				...
				<input type="textbox" placeholder="OAuth Client ID" name="client_id" style="width:80%;padding:3px" class="OAuth_required" value="<?php // phpcs:ignore --Squiz.PHP.EmbeddedPhp.ContentBeforeOpen since it's inside an input text area indenting will add spaces to the input.
				if ( $this->client_id ) {
					echo esc_attr( $this->client_id );}
				// phpcs:ignore --Squiz.PHP.EmbeddedPhp.ContentAfterEnd since it's inside an input text area indenting will add spaces to the input.?>" /></p>

				<p><b>OAuth 2.0 Client Secret : </b>&nbsp;<br/>
				<input type="textbox" placeholder="OAuth Client Secret" name="client_secret" class="OAuth_required" style="width:80%;padding:3px" value="<?php // phpcs:ignore --Squiz.PHP.EmbeddedPhp.ContentBeforeOpen since it's inside an input text area indenting will add spaces to the input.
			...
			>
				...
				<input type="textbox" placeholder="JWKS endpoint" name="jwks_endpoint" class="JWKS_required" style="width:80%;padding:3px" value="<?php // phpcs:ignore --Squiz.PHP.EmbeddedPhp.ContentBeforeOpen since it's inside an input text area indenting will add spaces to the input.
			...
			<div>
				...
				<table class="mo_settings_table">
					<tr>
						...
						<td style="vertical-align:top"><h4 class="mo_jwt_attr_h4 mo_jwt_placeholder_thin" style="margin-top:10px;"><input required class="mo_jwt_input" placeholder="JWT Username Attribute" type="text" name="mo_jwt_username_attr" value="<?php echo esc_attr( $this->attr_uname ); ?>" ></h4></td>
					</tr>
					<tr>
						...
						<td style="vertical-align:top"><h4 class="mo_jwt_attr_h4 mo_jwt_placeholder_thin"><input class="mo_jwt_input" placeholder="JWT Email Attribute" type="text" name="mo_jwt_email_attr" value="<?php echo esc_attr( $this->attr_email ); ?>" 
						<?php
						if ( ! $this->jwt_versi ) {
							echo 'disabled';}
						?>
					...
					<tr>
						...
						<td style="vertical-align:top"><h4 class="mo_jwt_attr_h4 mo_jwt_placeholder_thin" ><input class="mo_jwt_input" placeholder="JWT Firstname Attribute" type="text" name="mo_jwt_fname_attr" value="<?php echo esc_attr( $this->attr_fname ); ?>" 
						<?php
						if ( ! $this->jwt_versi ) {
							echo 'disabled';}
						?>
					...
					<tr>
						...
						<td style="vertical-align:top"><h4 class="mo_jwt_attr_h4 mo_jwt_placeholder_thin" ><input class="mo_jwt_input" placeholder="JWT Lastname Attribute" type="text" name="mo_jwt_lname_attr" value="<?php echo ( esc_attr( $this->attr_lname ) ); ?>" 
						<?php
						if ( ! $this->jwt_versi ) {
							echo 'disabled';}
						?>
					...
					<tr>
						...
						<td style="vertical-align:top"><h4 class="mo_jwt_attr_h4 mo_jwt_placeholder_thin" ><input class="mo_jwt_input" placeholder="JWT Display name Attribute" type="text" name="mo_jwt_dname_attr" value="<?php echo esc_attr( $this->attr_dname ); ?>" 
						<?php
						if ( ! $this->jwt_versi ) {
							echo 'disabled';}
						?>
					...
					<tr>
						...
						<td style="vertical-align:top"><h4 class="mo_jwt_attr_h4 mo_jwt_placeholder_thin" ><input class="mo_jwt_input" placeholder="JWT Custom value Attribute" type="text" name="mo_jwt_integrator_attr" value="<?php echo esc_attr( $this->attr_integrator ); ?>" 
						<?php
						if ( ! $this->jwt_versi ) {
							echo 'disabled';}
						?>
			...
			<div>
				...
				<table class="mo_settings_table" id='mo_jwt_role_mapping_table'>
					...
					if ( empty( $this->role_mapping ) ) {
						...
						<td><br><button class='button-primary' type='button' id='mo_jwt_remove_field_button' onclick='hide_dynamic_jwt_role_mapping_config(this);' style='font-weight: bold;   font-size: 13px;'>&#8722;</button></td>
						</tr>
							<?php
						}
					}
